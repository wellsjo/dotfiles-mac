...
map! <D-v> *
nnoremap <silent>  :call smooth_scroll#down(15, 20, 2)
...
map <silent>  :wincmd k
nnoremap  :call smooth_scroll#down(25, 20, 2)
map <silent>  :wincmd h
map <silent>  :wincmd l
nnoremap  :FZF
nnoremap <silent>  :call smooth_scroll#up(15, 20, 2)
...
nnoremap <S-Tab> :BufMRUPrev
snoremap <S-Tab> :BufMRUPrev
onoremap <S-Tab> :BufMRUPrev
vmap <BS> "-d
vmap <D-x> "*d
vmap <D-c> "*y
vmap <D-v> "-d"*P
...
set runtimepath+=~/.vim/plugged/AfterColors.vim/
set runtimepath+=~/.vim/plugged/vim-bracketed-paste/
set runtimepath+=~/.vim/plugged/vim-windowswap/
set runtimepath+=~/.vim/plugged/auto-pairs/
set runtimepath+=~/.vim/plugged/vim-sort-imports/
...
set runtimepath+=~/.vim/plugged/vim-bufmru/
...
set runtimepath+=~/.vim/plugged/auto_mkdir/
set runtimepath+=~/.vim/plugged/mru.vim/
...
set runtimepath+=~/.vim/plugged/vim-save-cursor-position/
set runtimepath+=~/.vim/plugged/govim/
set runtimepath+=~/.vim/plugged/vim-prettier/
set runtimepath+=~/.vim/plugged/wellsokai.vim/
...
tabnew
tabrewind
edit ~/src/cryptowatch/cw-sdk-node/src/types/client.ts
...
3
normal! 0
lcd ~/src/cryptowatch/cw-sdk-node/src/types
tabnext
edit ~/src/cryptowatch/cw-sdk-node/src/types/markets.ts
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
tabnext 1
set stal=1
badd +0 ~/src/cryptowatch/cw-sdk-node/src/types/client.ts
badd +0 ~/src/cryptowatch/cw-sdk-node/src/types/markets.ts
